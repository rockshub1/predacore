...
class MacDesktopNativeService:
    ...
    def __init__(self, log: logging.Logger | None = None) -> None:
        ...
        import os as _os
        _raw = _os.environ.get("PREDACORE_DESKTOP_ALLOWED_APPS", "").strip()
    ...
    def _check_allowed_app(self, app_name: str) -> None:
        """Enforce PREDACORE_DESKTOP_ALLOWED_APPS policy (mirrors desktop.py)."""
    ...
    def _screen_record_start(self, params: dict[str, Any]) -> dict[str, Any]:
        ...
        if not path:
            import tempfile
            fd, path = tempfile.mkstemp(prefix="predacore_screenrec_", suffix=".mov")
