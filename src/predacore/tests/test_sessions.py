...
# NOTE (2026-04-21): the TestLegacyStubSanitizer tests were removed as part
# of the Phase A refactor that moved tool-turn serialization into per-provider
# adapters. The sanitizer fought [Calling tool: X] text stubs that the old
# flat-path core.py emitted; with providers owning wire format, no poison
# stubs ever enter session history — the sanitizer became dead code.
