"""
PredaCore Plugin SDK — extensible tool and hook system.
...
Usage:
    from src.predacore.plugins import Plugin, hook, tool
...
def hook(event: str, priority: int = 100):
    ...
    Supported events:
        ...
        - on_startup: Called when PredaCore starts
        - on_shutdown: Called when PredaCore stops
...
class Plugin(ABC):
    """
    Base class for PredaCore plugins.
...
class PluginRegistry:
    """
    Central registry for all PredaCore plugins.
