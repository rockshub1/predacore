"""
Redis-backed rate limiter for PredaCore API endpoints.
...
logger = logging.getLogger("predacore.services.rate_limiter")
...
class RedisBackend:
    ...
    def __init__(self, redis_url: str = "") -> None:
        ...
        if "localhost" in self.redis_url and os.getenv("PREDACORE_ENV", "dev") == "production":
            logger.warning(
