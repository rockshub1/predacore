...
with PredaCore over WebSocket for real-time messaging.
...
class WebChatAdapter(ChannelAdapter):
    ...
    async def _index_handler(self, request: web.Request) -> web.Response:
        ...
        return web.Response(
            text="<h1>PredaCore WebChat</h1><p>Static files not found.</p>",
    ...
    async def _websocket_handler(self, request: web.Request) -> web.WebSocketResponse:
        ...
        await ws.send_json(
            {
                "type": "system",
                "content": "Connected to PredaCore. How can I help?",
    ...
    def _build_dashboard_stats(self) -> dict:
        ...
        try:
            ...
            identity_file = gs.get("files", {}).get("IDENTITY.md") or {}
            age_days = 0
...
<head>
    ...
    <title>PredaCore — PredaCore</title>
    <meta name="description" content="PredaCore AI Assistant — Personal AI powered by PredaCore">
        ...
        <header class="header">
            <div class="header-left">
                <div class="logo">
                    ...
                    <span class="logo-text">PredaCore</span>
                </div>
                <span class="header-subtitle">PredaCore</span>
            </div>
...
DEFAULT_STYLE_CSS = """/* PredaCore WebChat — Dark Glassmorphism Theme */
:root {
    --bg-primary: #0a0a0f;
    --bg-secondary: #12121a;
...
DEFAULT_APP_JS = """// PredaCore WebChat — WebSocket Client
(function() {
    'use strict';
