"""
PredaCore Tool Handlers — split into focused modules.
...
Module layout:
  ...
  identity.py          — identity_read, identity_update, journal_append
  cron.py              — cron_task
...
# ── Memory ──
from .memory import (
    handle_memory_bulk_abort,
    handle_memory_bulk_index,
    handle_memory_delete,
    handle_memory_explain,
    handle_memory_get,
    handle_memory_index_status,
    handle_memory_recall,
    handle_memory_scan_directory,
    handle_memory_stats,
    handle_memory_store,
)
...
HANDLER_MAP: dict[str, Callable] = {
    ...
    ToolName.MEMORY_BULK_INDEX: handle_memory_bulk_index,
    ToolName.MEMORY_BULK_ABORT: handle_memory_bulk_abort,
    ToolName.MEMORY_INDEX_STATUS: handle_memory_index_status,
    ToolName.MEMORY_SCAN_DIRECTORY: handle_memory_scan_directory,
    # Voice
    ...
    # Channel management + secrets
    ToolName.CHANNEL_CONFIGURE: handle_channel_configure,
    ToolName.CHANNEL_INSTALL: handle_channel_install,
    ToolName.SECRET_SET: handle_secret_set,
    ToolName.SECRET_LIST: handle_secret_list,
    # MCP (client side — manages third-party MCP servers)
    ToolName.MCP_LIST: handle_mcp_list,
    ToolName.MCP_ADD: handle_mcp_add,
    ToolName.MCP_REMOVE: handle_mcp_remove,
    ToolName.MCP_RESTART: handle_mcp_restart,
    # REST API registry
    ToolName.API_ADD: handle_api_add,
    ToolName.API_CALL: handle_api_call,
    ToolName.API_LIST: handle_api_list,
    ToolName.API_REMOVE: handle_api_remove,
    # Pipeline (tool chaining)
    ToolName.TOOL_PIPELINE: handle_tool_pipeline,
    # Collective intelligence
    ToolName.COLLECTIVE_INTELLIGENCE_STATUS: handle_collective_intelligence_status,
    ToolName.COLLECTIVE_INTELLIGENCE_SYNC: handle_collective_intelligence_sync,
...
__all__ = [
    ...
    "handle_memory_bulk_index", "handle_memory_scan_directory",
    "handle_memory_bulk_abort", "handle_memory_index_status",
    ...
    "handle_journal_append",
    "handle_channel_configure", "handle_channel_install",
    "handle_secret_set", "handle_secret_list",
    "handle_mcp_list", "handle_mcp_add", "handle_mcp_remove", "handle_mcp_restart",
    "make_mcp_tool_handler", "make_mcp_tool_schema",
    "handle_api_add", "handle_api_call", "handle_api_list", "handle_api_remove",
    "handle_cron_task",
