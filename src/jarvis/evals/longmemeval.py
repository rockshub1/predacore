"""
LongMemEval benchmark harness for JARVIS unified memory.
...
Usage:
    python -m jarvis.evals.longmemeval --dataset ~/datasets/longmemeval_s_cleaned.json
    python -m jarvis.evals.longmemeval --dataset ./lme_s.json --max-instances 50
    python -m jarvis.evals.longmemeval --dataset ./lme_s.json --top-k 10 --fetch-k 100
...
from jarvis.services.embedding import RustEmbeddingClient
...
async def run_benchmark(
    ...
    """Run LongMemEval against JARVIS memory and return aggregated metrics."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="LongMemEval benchmark for JARVIS unified memory",
