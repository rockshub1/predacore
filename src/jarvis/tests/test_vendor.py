"""
Tests for the JARVIS vendor layer (_vendor/).

Covers:
  - Skill System: SkillGenome, SkillStep, SkillCrystallizer, SkillScanner, Flame/HiveMind
...
@pytest.fixture
def skill_step():
    from jarvis._vendor.common.skill_genome import SkillStep
    return SkillStep(
...
class TestSkillGenome:
    ...
    def test_construction_defaults(self):
        from jarvis._vendor.common.skill_genome import CapabilityTier, SkillGenome, TrustLevel
        g = SkillGenome()
    ...
    def test_compute_tier_pure_logic(self):
        from jarvis._vendor.common.skill_genome import CapabilityTier, SkillGenome
    ...
    def test_to_dict_and_from_dict_roundtrip(self, signed_genome):
        from jarvis._vendor.common.skill_genome import SkillGenome
...
class TestTrustScore:
    def test_defaults(self):
        from jarvis._vendor.common.skill_genome import TrustLevel, TrustScore
        ts = TrustScore()
    ...
    def test_local_success_rate_zero_total(self):
        from jarvis._vendor.common.skill_genome import TrustScore
        ts = TrustScore()
...
class TestCapabilityTier:
    def test_ordering(self):
        from jarvis._vendor.common.skill_genome import CapabilityTier
    ...
    def test_tool_tier_map_coverage(self):
        from jarvis._vendor.common.skill_genome import TOOL_TIER_MAP, CapabilityTier
...
class TestTrustLevel:
    def test_values(self):
        from jarvis._vendor.common.skill_genome import TrustLevel
...
class TestScanVerdict:
    def test_values(self):
        from jarvis._vendor.common.skill_scanner import ScanVerdict
...
class TestScanFinding:
    def test_construction(self):
        from jarvis._vendor.common.skill_scanner import ScanFinding
        f = ScanFinding(
            rule="test_rule",
            severity="high",
...
class TestScanReport:
    def test_critical_count(self):
        from jarvis._vendor.common.skill_scanner import ScanFinding, ScanReport, ScanVerdict
        report = ScanReport(
            genome_id="test",
    ...
    def test_to_dict(self):
        from jarvis._vendor.common.skill_scanner import ScanReport, ScanVerdict
...
class TestSkillScanner:
    ...
    def _make_genome(self, steps=None, declared_tools=None, tier=None, name="test", creator="jarvis"):
        from jarvis._vendor.common.skill_genome import CapabilityTier, SkillGenome, SkillStep
        steps = steps or []
    ...
    def test_clean_skill(self):
        from jarvis._vendor.common.skill_scanner import ScanVerdict, SkillScanner
        from jarvis._vendor.common.skill_genome import SkillStep
    ...
    def test_undeclared_tool_detected(self):
        ...
        from jarvis._vendor.common.skill_scanner import ScanVerdict, SkillScanner
        from jarvis._vendor.common.skill_genome import SkillGenome, SkillStep
        scanner = SkillScanner()
        genome = SkillGenome(
            name="sneaky",
            creator_instance_id="jarvis",
    ...
    def test_empty_skill_flagged(self):
        ...
        from jarvis._vendor.common.skill_genome import SkillGenome
        scanner = SkillScanner()
        genome = SkillGenome(name="empty", creator_instance_id="jarvis")
        genome.sign()
        report = scanner.scan(genome)
        rules = [f.rule for f in report.findings]
    ...
    def test_verdict_rejected_on_critical(self):
        from jarvis._vendor.common.skill_scanner import ScanFinding, ScanVerdict, SkillScanner
        scanner = SkillScanner()
...
class TestSkillCrystallizer:
    ...
    def test_crystallize_with_sufficient_occurrences(self, tmp_dir):
        from jarvis._vendor.common.skill_evolution import MIN_PATTERN_OCCURRENCES, SkillCrystallizer
        crystallizer = SkillCrystallizer(data_dir=tmp_dir / "evo")
    ...
    def test_crystallize_rejects_non_crystallizable(self, tmp_dir):
        from jarvis._vendor.common.skill_evolution import DetectedPattern, SkillCrystallizer
        crystallizer = SkillCrystallizer(data_dir=tmp_dir / "evo")
...
class TestDetectedPattern:
    def test_success_rate(self):
        from jarvis._vendor.common.skill_evolution import DetectedPattern
        p = DetectedPattern(
            tool_sequence=("a", "b"),
            successes=8,
            failures=2,
...
class TestMCTSTree:
    ...
    def test_search_basic(self):
        from jarvis._vendor.core_strategic_engine.planner_enhancements import MCTSTree, SearchConfig
...
class TestPlanRanker:
    def test_rank_by_weighted_score(self):
        from jarvis._vendor.core_strategic_engine.planner_enhancements import PlanCandidate, PlanRanker
        ranker = PlanRanker()
...
class TestPlanMotifStore:
    def test_add_and_retrieve(self, tmp_dir):
        from jarvis._vendor.core_strategic_engine.plan_cache import PlanMotifStore
...
class TestHashingEmbeddingClient:
    ...
    async def test_deterministic(self):
        from jarvis._vendor.common.embedding import HashingEmbeddingClient
...
class TestResilientEmbeddingClient:
    ...
    async def test_primary_success(self):
        from jarvis._vendor.common.embedding import HashingEmbeddingClient, ResilientEmbeddingClient
    ...
    async def test_fallback_on_primary_failure(self):
        from jarvis._vendor.common.embedding import (
            EmbeddingClient,
    ...
    def test_sanitize_error_strips_api_key(self):
        from jarvis._vendor.common.embedding import ResilientEmbeddingClient
...
class TestGetDefaultEmbeddingClient:
    ...
    def test_auto_falls_back_to_hash_when_no_keys(self):
        ...
        with patch("jarvis._vendor.common.embedding._local_embedding_available", return_value=False):
    ...
    def test_explicit_openai_provider(self):
        from jarvis._vendor.common.embedding import ResilientEmbeddingClient, get_default_embedding_client
        client = get_default_embedding_client()
...
class TestInMemoryVectorIndex:
    def test_add_and_search(self):
        from jarvis._vendor.common.embedding import InMemoryVectorIndex
...
class TestAuditEntry:
    def test_to_dict(self):
        from jarvis._vendor.ethical_governance_module.persistent_audit import AuditEntry
        entry = AuditEntry(
            component="test",
            event_type="CHECK",
            is_compliant=True,
...
class TestCommonModels:
    def test_knowledge_node_construction(self):
        from jarvis._vendor.common.models import KnowledgeNode
        node = KnowledgeNode(
            labels={"Concept", "Tech"},
    ...
    def test_knowledge_edge_construction(self):
        from jarvis._vendor.common.models import KnowledgeEdge
        source_id = uuid4()
        target_id = uuid4()
        edge = KnowledgeEdge(
    ...
    def test_tool_description_construction(self):
        from jarvis._vendor.common.models import ToolDescription, ToolTypeEnum
    ...
    def test_interaction_request_and_result(self):
        from jarvis._vendor.common.models import (
            InteractionRequest,
            InteractionResult,
    ...
    def test_code_execution_request(self):
        from jarvis._vendor.common.models import CodeExecutionRequest
        req = CodeExecutionRequest(code="print('hello')", timeout_seconds=30)
        assert req.code == "print('hello')"
        assert req.timeout_seconds == 30

    def test_agent_description(self):
        from jarvis._vendor.common.models import AgentDescription
    ...
    def test_task_assignment(self):
        from jarvis._vendor.common.models import TaskAssignment
        step_id = uuid4()
        task = TaskAssignment(
...
class TestErrorHierarchy:
    def test_prometheus_error_base(self):
        from jarvis._vendor.common.errors import PrometheusError
    ...
    def test_tool_execution_error(self):
        from jarvis._vendor.common.errors import ToolExecutionError
        e = ToolExecutionError("tool failed")
        assert e.error_code == "TOOL_EXEC_FAILED"
        assert e.recoverable is True

    def test_tool_not_found_error(self):
        from jarvis._vendor.common.errors import ToolNotFoundError
        e = ToolNotFoundError("no such tool")
        assert e.recoverable is False

    def test_llm_rate_limit_error(self):
        from jarvis._vendor.common.errors import LLMRateLimitError
...
class TestUserProfile:
    def test_construction(self):
        from jarvis._vendor.user_modeling_engine.service import UserProfile
...
class TestUserModelingEngineService:
    ...
    def test_get_nonexistent_profile_returns_default(self, tmp_dir):
        from jarvis._vendor.user_modeling_engine.service import UserModelingEngineService
        svc = UserModelingEngineService(data_path=str(tmp_dir / "ume"))
    ...
    def test_safe_user_id(self):
        from jarvis._vendor.user_modeling_engine.service import _safe_user_id
...
class TestStructuredOutput:
    def test_validate_and_version_no_schema(self):
        from jarvis._vendor.common.structured_output import validate_and_version
...
class TestFlame:
    ...
    def test_publish_requires_endorsement(self, tmp_dir):
        from jarvis._vendor.common.skill_genome import SkillGenome, TrustScore
        from jarvis._vendor.common.skill_hivemind import Flame
        flame = Flame(
            instance_id="test",
            local_dir=tmp_dir / "local",
    ...
    def test_get_executable_skills(self, tmp_dir):
        from jarvis._vendor.common.skill_genome import SkillGenome, TrustLevel, TrustScore
        from jarvis._vendor.common.skill_hivemind import Flame
        flame = Flame(
            instance_id="test",
            local_dir=tmp_dir / "local",
    ...
    def test_sync_status_tracking(self, tmp_dir):
        from jarvis._vendor.common.skill_hivemind import SyncStatus
        ss = SyncStatus()
...
class TestLLMClients:
    def test_default_params(self):
        from jarvis._vendor.common.llm import default_params
        params = default_params(temperature=0.5, max_tokens=2048)
        assert params["temperature"] == 0.5
        assert params["max_tokens"] == 2048

    def test_get_default_llm_client_gemini_cli(self):
        from jarvis._vendor.common.llm import GeminiCLIClient, get_default_llm_client
    ...
    def test_get_default_llm_client_openai_requires_key(self):
        from jarvis._vendor.common.llm import get_default_llm_client
    ...
    def test_ollama_client_construction(self):
        from jarvis._vendor.common.llm import OllamaClient
...
class TestTierPropagation:
    def test_all_tiers_have_propagation_rules(self):
        from jarvis._vendor.common.skill_genome import CapabilityTier, TIER_PROPAGATION
...
class TestSensitivePaths:
    def test_env_files_sensitive(self):
        from jarvis._vendor.common.skill_genome import SENSITIVE_PATHS
...
class TestDeepMerge:
    def test_flat_merge(self):
        from jarvis._vendor.user_modeling_engine.service import _deep_merge
        base = {"a": 1, "b": 2}
        override = {"b": 3, "c": 4}
