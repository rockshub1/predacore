"""
Comprehensive tests for jarvis.sessions — JSONL-based session persistence.
...
from jarvis.sessions import Message, Session, SessionStore
...
class TestSession:
    ...
    def test_auto_title_from_first_user_message(self):
        s = Session()
        s.add_message("user", "How do I configure JARVIS?")
        assert s.title == "How do I configure JARVIS?"
...
class TestLegacyStubSanitizer:
    """Tests for _sanitize_legacy_tool_stubs in jarvis.sessions."""

    def test_empty_string_returns_empty(self):
        from jarvis.sessions import _sanitize_legacy_tool_stubs
