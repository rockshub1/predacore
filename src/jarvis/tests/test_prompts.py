"""
Comprehensive tests for jarvis.prompts — persona drift detection,
...
from jarvis.identity.engine import _read_cached as _read_file_cached
...
class TestPersonaDriftPatterns:
    ...
    def test_generic_model_identity(self):
        ...
        assert not pattern.search("JARVIS here, ready to help")
    ...
    def test_foreign_identity_openai(self):
        ...
        assert not pattern.search("i am jarvis")
...
class TestVerificationPatterns:
    ...
    def test_persona_identity_query(self):
        ...
        assert PERSONA_IDENTITY_QUERY_RE.search("are you jarvis")
