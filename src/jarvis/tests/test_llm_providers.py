"""
Comprehensive tests for jarvis.llm_providers — LLM router, circuit breaker,
...
from jarvis.llm_providers.base import LLMProvider, ProviderConfig
from jarvis.llm_providers.circuit_breaker import CircuitBreaker
from jarvis.llm_providers.text_tool_adapter import (
...
class TestLLMInterfaceRouter:
    ...
    def mock_config(self):
        from jarvis.config import JARVISConfig, LLMConfig
        cfg = JARVISConfig()
        cfg.llm = LLMConfig(
            provider="mock",
