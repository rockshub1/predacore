"""
JARVIS Cron Engine — lightweight scheduled task execution.

Reads job definitions from ~/.prometheus/cron.yaml and executes
...
class CronEngine:
    ...
    def __init__(self, config: JARVISConfig, gateway):
        self.config = config
    ...
    def _load_jobs(self) -> None:
        """Load cron jobs from ~/.prometheus/cron.yaml."""
        if yaml is None:
