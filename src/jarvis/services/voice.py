...
# JARVIS default: bm_george (British, fastest, most JARVIS-like)
...
class KokoroTTS(TTSProvider):
    ...
    Default JARVIS voice: bm_george (British Male, refined, fastest).
    """
