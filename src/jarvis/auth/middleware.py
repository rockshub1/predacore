"""
Auth Middleware — JWT verification + API key authentication for JARVIS.
...
logger = logging.getLogger("jarvis.auth.middleware")
...
class AuthMiddleware:
    ...
    def __init__(
        ...
        self.jwt_secret = jwt_secret or os.getenv("JARVIS_JWT_SECRET", "")
