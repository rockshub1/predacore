"""
JARVIS Security Module — Prompt injection defense and credential safety.
...
Usage:
    from jarvis.auth.security import sanitize_tool_output, detect_injection, redact_secrets
