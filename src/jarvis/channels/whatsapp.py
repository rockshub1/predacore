"""
WhatsApp Channel Adapter — connects JARVIS via WhatsApp Business Cloud API.
...
class WhatsAppAdapter(ChannelAdapter):
    ...
    def __init__(self, config: JARVISConfig):
        ...
        self._verify_token = wa_config.get("verify_token", "jarvis_webhook_verify")
    ...
    async def start(self) -> None:
        ...
        bind_host = os.environ.get("JARVIS_WHATSAPP_BIND_HOST", "127.0.0.1")
