"""
Telegram Channel Adapter — connects JARVIS to Telegram via Bot API.
...
Setup:
  ...
  4. Start the daemon: prometheus start --daemon
...
class TelegramAdapter(ChannelAdapter):
    ...
    async def _cmd_start(self, update, context) -> None:
        ...
        await update.message.reply_text(
            "🔥 *JARVIS Online*\n\n"
            "I'm your AI assistant powered by Project Prometheus.\n"
