...
Usage:
    service = MemoryService(data_path="~/.prometheus/data")
    await service.store("User prefers dark mode", user_id="shubham",
                        memory_type=MemoryType.PREFERENCE,
                        importance=ImportanceLevel.HIGH)
    results = await service.recall("dark mode preference", user_id="shubham")
"""
