...
_SIGNING_SECRET = os.getenv("JARVIS_SKILL_SIGNING_SECRET", "").encode("utf-8") or (
    hashlib.sha256(
...
class SkillGenome:
    ...
    # Origin
    creator_instance_id: str = ""      # which JARVIS instance created this
    creator_user: str = ""             # which user's JARVIS
