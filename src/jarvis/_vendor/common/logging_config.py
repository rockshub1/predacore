"""
Jarvis Structured Logging — JSON logs with trace_id correlation.
...
Usage:
    ...
    logger.info("Processing message", extra={"user_id": "shubham", "channel": "cli"})
"""
...
def get_trace_id() -> str:
    ...
    try:
        from jarvis._vendor.common.metrics import get_trace_id as _get
    except Exception:  # pragma: no cover
        from jarvis._vendor.common.metrics import get_trace_id as _get  # type: ignore
    return _get()
...
class JSONFormatter(logging.Formatter):
    ...
    Output format:
    {"ts":"2026-02-21T02:30:00Z","level":"INFO","logger":"jarvis.core",
     "msg":"Processing message","trace_id":"abc123","user_id":"shubham"}
    """
...
class PrettyFormatter(logging.Formatter):
    ...
    Output:
    02:30:00 ▸ INFO   jarvis.core       Processing message  [trace:abc123]
    """
...
def setup_logging(
    ...
    """
    Configure the root logger for the entire Jarvis system.
...
def get_logger(name: str) -> logging.Logger:
    ...
    Usage:
        logger = get_logger("jarvis.core")
        logger.info("Processing", extra={"user_id": "shubham"})
    """
