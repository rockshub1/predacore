"""
Skill Scanner — Three-point security analysis for hive mind skills.

Scans skills at three checkpoints:
  1. On publish  — creator JARVIS scans before sharing
  2. At the pool — hive mind registry scans on arrival
  3. On receive  — every receiving JARVIS scans before sandbox trial
