"""
JARVIS Tool Executor — thin facade over focused subsystem modules.
...
class ToolExecutor:
    ...
    def __init__(self, config: JARVISConfig) -> None:
        ...
        self._tool_rate_max = int(os.getenv("JARVIS_TOOL_RATE_LIMIT", "120"))
        self._tool_timeout = int(os.getenv("JARVIS_TOOL_TIMEOUT_SECONDS", "120"))
    ...
    async def _http_with_retry(
        ...
        **kwargs: Any,
        ...
        import httpx
        from jarvis.auth.security import validate_url_ssrf
