...
class SkillDefinition:
    ...
    id: str  # Unique identifier like "prometheus.web-scraper" or "community.email-summarizer"
    name: str
    description: str
    version: str = "1.0.0"
    author: str = ""
