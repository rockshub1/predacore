...
class TestAgentCollaboration(unittest.TestCase):
    ...
    def test_result_aggregator(self):
        from predacore.agents.collaboration import AgentResult, ResultAggregator
...
class TestSWEBenchEval(unittest.TestCase):
    ...
    def test_exact_match_scorer(self):
        from predacore.evals.swe_bench import EvalScorer
    ...
    def test_eval_runner_pass(self):
        from predacore.evals.swe_bench import EvalRunner, EvalTask
    ...
    def test_eval_report_to_dict(self):
        from predacore.evals.swe_bench import EvalReport
    ...
    def test_sample_tasks_exist(self):
        from predacore.evals.swe_bench import SAMPLE_TASKS
...
class TestALEBenchEval(unittest.TestCase):
    ...
    def test_tool_accuracy(self):
        from predacore.evals.ale_bench import AgentScorer
    ...
    def test_plan_quality_ideal(self):
        from predacore.evals.ale_bench import AgentAction, AgentScorer
    ...
    def test_scenario_runner(self):
        from predacore.evals.ale_bench import (
            AgentAction,
            AgentEvalRunner,
            AgentScenario,
            CapabilityCategory,
    ...
    def test_sample_scenarios_exist(self):
        from predacore.evals.ale_bench import SAMPLE_SCENARIOS
...
class TestMCTSEnhancements(unittest.TestCase):
    ...
    def test_search_config_defaults(self):
        from predacore._vendor.core_strategic_engine.planner_enhancements import SearchConfig
