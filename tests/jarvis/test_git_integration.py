...
from src.jarvis.services.git_integration import (
    DiffSummary,
    FileDiff,
...
class TestFindCommonScope:
    def test_common_directory(self):
        paths = ["src/jarvis/core.py", "src/jarvis/config.py"]
        assert _find_common_scope(paths) == "jarvis"
