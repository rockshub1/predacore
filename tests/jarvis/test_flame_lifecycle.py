...
class TestSkillGenome:
    ...
    def test_create_genome(self):
        from jarvis._vendor.common.skill_genome import SkillGenome, SkillStep, CapabilityTier
    ...
    def test_propagation_requirements(self):
        from jarvis._vendor.common.skill_genome import SkillGenome, SkillStep, TrustLevel
        genome = SkillGenome(
            name="no-propagate",
...
class TestTrustScore:
    ...
    def test_initial_trust(self):
        from jarvis._vendor.common.skill_genome import TrustScore, TrustLevel
        trust = TrustScore()
...
class TestSkillScanner:
    ...
    def test_clean_skill_passes(self):
        from jarvis._vendor.common.skill_scanner import SkillScanner, ScanVerdict
        from jarvis._vendor.common.skill_genome import SkillGenome, SkillStep, CapabilityTier
...
class TestFlameLifecycle:
    ...
    def _make_endorsed_genome(self, creator: str = "instance_a"):
        ...
        from jarvis._vendor.common.skill_genome import SkillGenome, SkillStep, TrustLevel, CapabilityTier
        genome = SkillGenome(
...
class TestSkillMarketplace:
    ...
    def test_list_builtin_skills(self):
        from jarvis.tools.skill_marketplace import SkillMarketplace
...
class TestFlameHandlers:
    """Hivemind tool handlers work end-to-end."""
    ...
    @pytest.mark.asyncio
    async def test_hivemind_status(self, ctx):
        from jarvis.tools.handlers.hivemind import handle_hivemind_status
        result = await handle_hivemind_status({}, ctx)
        data = json.loads(result)
        assert "hivemind" in data
    ...
    async def test_skill_evolve_stats(self, ctx):
        ...
        from jarvis.tools.handlers.hivemind import handle_skill_evolve
