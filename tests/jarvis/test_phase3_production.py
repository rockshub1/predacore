...
class TestAuthMiddleware:
    ...
    def test_create_and_verify_jwt(self):
        from jarvis.auth.middleware import create_jwt_hs256, verify_jwt_hs256
    ...
    def test_jwt_invalid_format(self):
        from jarvis.auth.middleware import verify_jwt_hs256

        with pytest.raises(ValueError, match="Invalid JWT format"):
            verify_jwt_hs256("not.a.valid.token.format", "s")

    def test_auth_context(self):
        from jarvis.auth.middleware import AuthContext, AuthMethod
    ...
    def test_anonymous_context(self):
        from jarvis.auth.middleware import AuthContext

        ctx = AuthContext()
        assert not ctx.is_authenticated

    def test_api_key_store(self):
        from jarvis.auth.middleware import APIKeyStore
    ...
    def test_api_key_expiration(self):
        from jarvis.auth.middleware import APIKey
    ...
    def test_middleware_jwt_auth(self):
        from jarvis.auth.middleware import AuthMiddleware, create_jwt_hs256
    ...
    def test_middleware_api_key_auth(self):
        from jarvis.auth.middleware import AuthMiddleware
    ...
    def test_middleware_anonymous_allowed(self):
        from jarvis.auth.middleware import AuthMethod, AuthMiddleware
...
class TestRateLimiter:
    ...
    def test_fixed_window_allows(self):
        from jarvis.services.rate_limiter import InMemoryBackend
    ...
    def test_rate_limit_headers(self):
        from jarvis.services.rate_limiter import RateLimitResult
    ...
    def test_rate_limiter_service(self):
        from jarvis.services.rate_limiter import RateLimitConfig, RateLimiter
    ...
    def test_rate_limiter_no_rules(self):
        from jarvis.services.rate_limiter import RateLimiter
    ...
    def test_default_presets(self):
        from jarvis.services.rate_limiter import default_api_limits
...
class TestAlerting:
    ...
    def test_alert_creation(self):
        from jarvis.services.alerting import Alert, AlertSeverity
    ...
    def test_alert_manager_fire_log(self):
        from jarvis.services.alerting import Alert, AlertManager, AlertSeverity
    ...
    def test_slack_dispatcher_not_configured(self):
        from jarvis.services.alerting import Alert, SlackDispatcher
    ...
    def test_pagerduty_dispatcher_not_configured(self):
        from jarvis.services.alerting import Alert, PagerDutyDispatcher
...
class TestLoadTest:
    ...
    def test_request_result(self):
        from jarvis.evals.load_test import RequestResult
    ...
    def test_load_test_report(self):
        from jarvis.evals.load_test import LoadTestConfig, LoadTestReport, RequestResult
    ...
    async def test_load_test_runner(self):
        from jarvis.evals.load_test import LoadTestConfig, LoadTestRunner, RequestResult
