...
class TestPluginSDK:
    ...
    def test_tool_decorator_metadata(self):
        from jarvis.services.plugins import tool
    ...
    def test_hook_decorator_metadata(self):
        from jarvis.services.plugins import hook
    ...
    def test_plugin_class_tools_discovery(self):
        from jarvis.services.plugins import Plugin, tool
    ...
    def test_plugin_class_hooks_discovery(self):
        from jarvis.services.plugins import Plugin, hook
    ...
    def test_plugin_enable_disable(self):
        from jarvis.services.plugins import Plugin
    ...
    async def test_registry_load_plugin(self):
        from jarvis.services.plugins import Plugin, PluginRegistry, tool
    ...
    async def test_registry_duplicate_name_error(self):
        from jarvis.services.plugins import Plugin, PluginRegistry
    ...
    async def test_registry_dispatch_hook(self):
        from jarvis.services.plugins import Plugin, PluginRegistry, hook
...
class TestTranscriptWriter:
    ...
    def test_start_session_creates_file(self):
        from jarvis.services.transcripts import TranscriptWriter
    ...
    def test_transcript_entry_serialization(self):
        from jarvis.services.transcripts import TranscriptEntry
...
class TestSandboxSessions:
    ...
    def test_sandbox_config_defaults(self):
        from jarvis.auth.sandbox import SandboxConfig
    ...
    def test_session_sandbox_init(self):
        from jarvis.auth.sandbox import SandboxConfig, SessionSandbox
    ...
    def test_session_sandbox_volume_name(self):
        ...
        assert "jarvis-sandbox-" in sandbox.volume_name
    ...
    def test_language_config(self):
        from jarvis.auth.sandbox import _get_language_config
...
class TestVoiceInterface:
    ...
    def test_voice_config_defaults(self):
        from jarvis.services.voice import VoiceConfig, VoiceProvider
    ...
    def test_transcription_result(self):
        from jarvis.services.voice import TranscriptionResult
    ...
    def test_synthesis_result(self):
        from jarvis.services.voice import SynthesisResult
    ...
    def test_voice_provider_enum(self):
        from jarvis.services.voice import VoiceProvider
    ...
    async def test_transcribe_raises_without_stt(self):
        from jarvis.services.voice import VoiceConfig, VoiceInterface, VoiceProvider
