...
from src.jarvis.memory.retriever import MemoryRetriever
...
class _FakeStore:
    async def recall(self, **kwargs):
        ...
        return [
            (
                {
                    "content": "Jarvis should remember long-term preferences.",
                    "memory_type": "fact",
                    "importance": 3,
...
async def test_build_context_accepts_iso_created_at_strings():
    ...
    assert "Jarvis should remember long-term preferences." in context
